  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-8 md:px-16 lg:px-20 bg-white relative overflow-hidden">
        ...
        <div className="max-w-8xl mx-10 text-left relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-3 mb-10">
              <span className="text-[#E23744] font-black uppercase tracking-[0.5em] para-md">Our Blogs</span>
              <div className="h-px w-10 bg-gray-300" />
            </div>
            <h1 className="heading-1 font-bold text-[#2D2D2D] mb-15 leading-[-1.05] tracking-tighter uppercase">
      ...
      {/* Blog Grid - Updated to use displayedPosts */}
      <section className="pb-24 px-8 md:px-16 lg:px-20">
        <div className="max-w-8xl mx-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 space-y-5">
            {displayedPosts.map((post, idx) => (
              <motion.div key={post.id} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: idx * 0.1 }} className="group cursor-pointer">
                ...
                <div>
                  <span className="para-xs font-black tracking-[0.3em] text-[#E23744] uppercase mb-3 block">{post.category}</span>
                  ...
                  <Link to={`/resources/blogs/${post.id}`} className="inline-flex items-center gap-3 text-[#2D2D2D] font-black para-xs uppercase tracking-widest hover:text-[#3E4D86] transition-colors group/btn">
          ...
          {visibleCount < posts.length && (
            <div className="mt-20 text-center">
              <button 
                onClick={handleLoadMore} // Click handler added
      ...
      {/* Bottom CTA Section remains strictly consistent */}
        ...
        <div className="max-w-8xl mx-10">
          <div className="bg-[#2D2D2D] rounded-[3.5rem] p-12 md:p-24 flex flex-col lg:flex-row items-center justify-between gap-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="max-w-xl text-center lg:text-left relative z-10">
              ...
              <h2 className="heading-1 font-bold text-white mb-10 uppercase tracking-tighter leading-[-1.5]">
                Need Expert <br />
            ...
            <div className="flex flex-wrap justify-center gap-6 relative z-10 gap-15">
