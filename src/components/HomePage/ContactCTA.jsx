      ...
      <div className="relative z-10 max-w-6xl mx-auto px-10 lg:px-20">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 mb-5">
            <button className="group relative flex items-center gap-3 px-10 py-5 bg-[#E23744] text-white font-bold rounded-2xl shadow-xl shadow-red-900/10 hover:shadow-red-900/20 hover:-translate-y-1 transition-all duration-300 uppercase para-xs tracking-widest">
              <Mail size={18} className="transition-transform group-hover:rotate-12" />
              Request a Corporate Proposal
            </button>
            
            <button className="flex items-center gap-3 px-10 py-5 bg-white border border-gray-200 text-[#2D2D2D] font-bold rounded-2xl hover:bg-[#F4F4F2] hover:border-[#3E4D86] hover:-translate-y-1 transition-all duration-300 uppercase para-xs tracking-widest">
          ...
          <div className="mt-16 flex items-center gap-3 opacity-30 grayscale">
             ...
             <span className="para-xs font-bold uppercase tracking-[0.2em]">Trusted Since 1997</span>
             <div className="h-px w-12 bg-black" />
          </div>
